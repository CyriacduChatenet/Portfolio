      ...
      >
        {about.map((about) => (
          <main
            key={about._id}
            className={
              "px-8 sm:px-10 md:px-12 lg:px-14 xl:px-16 2xl:px-24 py-12 bg-white text-sm"
            }
            ref={ref}
          >
            ...
            <div
              className={
                "flex flex-col-reverse xl:flex-row xl:items-center xl:justify-between"
              }
            >
              ...
              <Image
                src={sanityUrlFor(about.thumbnail.asset._ref).url()}
                width={500}
                height={500}
                alt={"my profile"}
                className={"pb-10"}
            ...
            <div className={""}>
              <h2
                className={
                  "font-secondary uppercase text-blue text-7xl xl:text-8xl md:pt-12"
                }
                ref={skillsTitleRef}
              >
                Skills
              ...
              <ul
                className={
                  "py-4 flex flex-col sm:flex-row flex-wrap justify-between lg:justify-around lg:px-20"
                }
              >
                {about.skills.map((skill: any, index: number) => (
                  <li
                    className={"py-2 sm:px-8"}
                    key={skill.name}
                    id={`lang-${index}`}
                  >
                    <a
